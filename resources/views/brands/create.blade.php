        ...
        <div class="row mb-lg-4 mb-3 mt-lg-3 mt-3">
            <div class="col-md-8 mx-auto">
                ...
                <div class="blushed-card mt-3 py-lg-4 px-lg-4">
                    <h1 class="f-24 w-600">Add New Brand</h1>
                    <p class="f-18 w-500 " style="color: #84818A !important;">
                        Please provide necessary information about brand
                    </p>

                    <form action="{{ URL::to('/brands') }}" method="POST" class="sign__frame-right--form">
                        @csrf
                        ...
                        <div class="row w-100 align-items-center">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-floating w-100 mb-4">
                                    ...
                                    <label for="floatingSelect sign-label">Select Status</label>
                                </div>
                            </div>
                            {{-- featured --}}
                            {{-- <div class="col-md-6 col-12">
                        ...
                        <div class="col-lg-12">
                            <div class="d-flex" style="float:right;">
                                <button class="sign-btn">Add Brand</button>
                            </div>
                        </div>
                    </form>
                </div>
