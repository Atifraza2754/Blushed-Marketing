                        ...
                        <tbody>
                            @foreach ($payrolls as $payroll)
                                <tr class="">
                                    ...
                                    <td>
                                        <p class="mb-0 pb-0"><strong>{{ $payroll->user->name }}</strong></p>
                                        <p class="mb-0 pb-0 text-muted"><small>{{ $payroll->user->email }}</small></p>
                                    </td>
                                    <td>
                                        <p class="mb-0 pb-0">{{ $payroll->name }}</p>
                                    </td>
                                    <td>
                                        <p class="mb-0 pb-0">{{ $payroll->email_address }}</p>
                                    </td>
                                    <td>
                                        {{ $payroll->address }}
                                    </td>
                                    <td>{{ $payroll->payment_preference }}</td>
                                    <td>
                                        <div class="d-flex align-items-center justify-content-end">
                                            <div class="eye mx-3 table-action cursor-pointer">
                                                <a href='{{ URL::to("/onboarding/payroll/$payroll->id") }}'
                                                    class="no-decoration">
