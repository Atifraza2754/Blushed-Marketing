    ...
    <div class="container">
        <div class="row mb-lg-4 mb-3 mt-lg-3 mt-3">
            <div class="col-lg-12">
                ...
                <h1 class="f-32 w-600 "> Upload Bulk Users</h1>
                <div class="blushed-card mt-3 py-lg-4 px-lg-4">
                    <h1 class="f-24 w-600">Invite users to Blushed App</h1>
                    <p class="f-18 w-500 " style="color: #84818A !important;">Upload CSV to Invite User to blushed</p>

                    <form action="{{ URL::to('/admin/bulk-upload/store') }}" method="POST" class="sign__frame-right--form"
                        ...
                        <div class="row w-100 align-items-center">
                            ...
                            <div class="col-lg-5 col-md-5 col-10">
                                <div class="form-floating mb-4 w-100">
                                    <input type="file" class="form-control sign-input " id="floatingInput" name="file"
                                        value="" required>
                                    <label for="floatingInput" class="sign-label">Upload File</label>
                                </div>
                            </div>
                            <div class="btn-group col-md-3">

                                <a href="{{ asset('assets/files/bulkupload.csv') }}" class="btn btn-primary btn-sm py-1">Download
                                    Sample</a>
                            </div>
                            {{-- add btn --}}
                            {{-- <div class="col-2 ">
