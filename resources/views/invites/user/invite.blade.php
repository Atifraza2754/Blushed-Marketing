    ...
    <div class="container">
        <div class="row mb-lg-4 mb-3 mt-lg-3 mt-3">
            <div class="col-lg-12">
                ...
                <h1 class="f-32 w-600 "> Invite Users</h1>
                <div class="blushed-card mt-3 py-lg-4 px-lg-4">
                    <h1 class="f-24 w-600">Invite users to Blushed App</h1>
                    <p class="f-18 w-500 " style="color: #84818A !important;">Enter email or send QR to
                        invite users on Blushed</p>

                    <form action="{{ URL::to('/user/invites/store') }}" method="POST" class="sign__frame-right--form">
                        @csrf
