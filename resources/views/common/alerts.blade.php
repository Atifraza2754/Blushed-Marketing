...
@if (Session::has('Alert') && Session::get('Alert')['status'] == 100)
    <div class="alert alert-danger alert-dismissible text-bg-danger border-0 fade show w-100" role="alert">
...
@if (Session::has('Alert') && Session::get('Alert')['status'] == 200)
    <div class="alert alert-success alert-dismissible text-bg-success border-0 fade show w-100" role="alert">
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="alert" aria-label="Close"
            fdprocessedid="w40b6k"></button>
...
{{-- Validation Errors --}}
@if ($errors->any())
    <div class="alert alert-danger fade show px-3 w-100" role="alert">
