...
@section('content')
    <div class="sign__frame-right sign__frame-right2">
        ...
        <form action="{{ URL::to('/forget-password') }}" method="post" class="sign__frame-right--form">
            @csrf

            <h1 class="f-36 w-600 ">Verify your identity</h1>
            ...
            <div class="d-flex align-items-start">
                ...
                <div class="forget-text ms-3 mb-0">
                    <p class="mb-0 pb-0 pt-1">Email code to</p>
                </div>
            </div>

            {{-- email --}}
            <div class="form-floating w-100 mb-3">
                <input type="email" name="email" class="form-control sign-input pt-1" placeholder="abc@example.com"
                    required>
            </div>
