                ...
                <tr>
                    <td align="left" valign="center" style="margin-top: 50px;">
                        <div
                            ...
                            <div style="padding-bottom: 10px">Only {{ $details['time'] }}  are Remaining</div>
                            <div style="padding-bottom: 30px">
                                Dear <b> {{ $details['name'] }} </b>, your Quiz for <i><b>' {{$details['brand_name']}}  </b></i> is due.
                                 Submit it as soon as possible. <b style="color:red !important"></b> <br>
