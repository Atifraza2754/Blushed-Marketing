                ...
                <tr>
                    <td align="left" valign="center" style="margin-top: 50px;">
                        <div
                            ...
                            <div style="padding-bottom: 10px">Only 60 Hours are Remaining</div>
                            <div style="padding-bottom: 30px">
                                Dear <b> {{ $details['name'] }} </b>, your Shift Confirmation for <i><b>' {{$details['brand_name']}}  </b></i> is due.
                             Please Confirm it as soon as possible<b style="color:red !important"></b><br>
                                <a href={{ $details['link'] }} style="">Click here </a> to Confirm'
