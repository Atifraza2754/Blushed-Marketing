                ...
                <tr>
                    <td align="left" valign="center" style="margin-top: 50px;">
                        <div
                            ...
                            <div style="padding-bottom: 10px">Only 36 Hours are Remaining</div>
                            <div style="padding-bottom: 30px">
                                Dear <b> {{ $details['name'] }} </b>, your Recap for <i><b>' {{$details['brand_name']}}  </b></i> is due.
                                 Submit it as soon as possible otherwise <b style="color:red !important">$5</b> will be deducted after every 24 hours.<br>
                                <a href={{ $details['link'] }} style="">Click here </a> to Submit'
