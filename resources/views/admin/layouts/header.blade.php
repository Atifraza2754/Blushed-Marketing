    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="{{ URL::to('/admin/dashboard') }}">
                <img alt="logo" src="{{ URL::to('/assets/img/logos/logo.png') }}">
                <span class="navbar-brand-name">WeMaintain CRM</span>
            </a>
        </div>
        ...
        <ul class="navbar-item flex-row nav-dropdowns">
                ...
                <div class="dropdown custom-dropdown-icon">
                    <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                            src="{{ URL::to('/assets/img/flag-ca.svg') }}" class="flag-width"
            ...
            <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                    ...
                    <div class="media">
                        ...
                        @if (Auth::user()->profile_image)
                            <img src='{{ URL::to('/storage/images/users/sm/' . Auth::user()->profile_image) }}'
                                class="rounded mw-100 img-fluid" alt="profile image">
                        @else
                            <img src="{{ URL::to('/assets/img/placeholders/user.png') }}"
                                class="rounded mw-100 img-fluid" alt="avatar">
                        @endif
                        {{-- <img src="{{ URL::to('/assets/img/90x90.jpg') }}" class="img-fluid" alt="admin-profile"> --}}
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <a href="{{ URL::to('/admin/settings/profile') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
