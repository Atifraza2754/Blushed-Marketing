    ...
    <nav id="topbar">
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="index.html">
                    <img src="{{ URL::to('/assets/img/90x90.jpg') }}" class="navbar-logo" alt="logo">
                </a>
            </li>
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            {{-- dashboard --}}
            <li class="menu single-menu {{ $module == 'dashboard' ? 'active' : '' }}">
            ...
            @if (Auth::id() == 1)
                {{-- agents --}}
                <li class="menu single-menu {{ $module == 'agents' ? 'active' : '' }}">
            ...
            {{-- cases --}}
            <li class="menu single-menu {{ $module == 'cases' ? 'active' : '' }}">
                <a href="{{ URL::to('/admin/cases') }}">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                    <li>
                        <a href="{{ URL::to('/admin/settings/profile') }}"> Profile </a>
                    </li>
                    <li>
                        <a href="{{ URL::to('/admin/settings/password') }}"> Password </a>
                    </li>
                    {{-- <li>
                        <a href="{{ URL::to('/admin/settings/site') }}"> Site Settings </a>
                    </li> --}}
                </ul>
            </li>
                ...
                <ul class="collapse submenu list-unstyled" id="page" data-parent="#topAccordion">
                    ...
                    <li class="sub-sub-submenu-list">
                        <a href="#user-login" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            Login <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                <polyline points="9 18 15 12 9 6"></polyline>
                            </svg> </a>
                    ...
                    <li class="sub-sub-submenu-list">
                        ...
                        <ul class="collapse list-unstyled sub-submenu" id="user-passRecovery" data-parent="#page">
                            ...
                            <li>
                                <a target="_blank" href="auth_pass_recovery_boxed.html"> Recover ID Boxed
                                </a>
                            </li>
                        </ul>
                    </li>
