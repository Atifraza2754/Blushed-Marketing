...
@extends($layout, ['module' => 'team-recap'])
            ...
            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="tab-div">
                            <div class="tab">
                                ...
                                <a href="{{ URL::to('/user/team-recap/submitted') }}">
                                    <button class="{{ $slug == 'submitted' ? 'active' : '' }}">Submitted</button>
                                </a>
                                <a href="{{ URL::to('/user/team-recap/redos') }}">
                                    <button class="{{ $slug == 'redos' ? 'active' : '' }}">Redos</button>
                                </a>
                                <a href="{{ URL::to('/user/team-recap/approved') }}">
                ...
                @else
                    <div class="col-md-12">
                        <div class="tab-div">
                            <div class="tab">
                                <a href="{{ URL::to('/team-recap') }}">
                                    <button class="{{ $slug == null ? 'active' : '' }}">All Recaps</button>
                                </a>
                                <a href="{{ URL::to('/team-recap/approved') }}">
                                    <button class="{{ $slug == 'approved' ? 'active' : '' }}">Approved</button>
                                </a>
                                <a href="{{ URL::to('/team-recap/pending') }}">
                                    <button class="{{ $slug == 'pending' ? 'active' : '' }}">Pending</button>
                                </a>
                                <a href="{{ URL::to('/team-recap/rejected') }}">
                                    <button class="{{ $slug == 'rejected' ? 'active' : '' }}">Rejected</button>
                                </a>
                                <a href="{{ URL::to('/team-recap/due') }}">
                                    <button class="{{ $slug == 'due' ? 'active' : '' }}">Due</button>
                                </a>
                            </div>
                        </div>
                                ...
                                {{-- @if($uc->recap != null ) --}}
                                    ...
                                    @if (Auth::user()->role_id == 5)
                                        ...
                                        @else
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <p class="mb-0 pb-0">{{ date('Y-M-d, H:i a' , strtotime($uc->submit_date)) }}</p>
                                                </div>
                                            </td>
                                        @endif
                                        {{-- <td>
                                            <div class="d-flex align-items-center justify-content-start">
                                                <div class="eye  table-action cursor-pointer">
                                                    @if (Auth::user()->role_id == 5)
                                                        <a href="{{ URL::to("/user/recap/$uc->id") }}"
                                                            class="no-decoration">
