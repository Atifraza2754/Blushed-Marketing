 ...
 <div class="modal fade" id="exampleModal-reject-edit" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
             <div class="modal-header mt-1">
                 <h5 class="f-18 w-600" id="exampleModalLabel">Reject With Edit</h5>
             </div>
             <div class="modal-body pt-0">
                 <form class="sign__frame-right--form"
                     action='{{ URL::to("/recap/$user_recap->id/reject-with-edit") }}' method="POST">
                     @csrf
