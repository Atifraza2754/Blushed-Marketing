                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="d-flex justify-content-between align-items-center flex-md-row flex-column mb-3">
                            <h1 class="f-22 w-600 text-bl">Quizzes</h1>
                            <div
                        ...
                        <div class="tab-div">
                            <div class="tab">
                                <a href="{{ URL::to('/learning-center/quizzes') }}" class="tab-btn tab-btn-active">Quiz
                                    List</a>
                                <a href="{{ URL::to('/learning-center/user-quizzes') }}" class="tab-btn">User Submitted
                                    Quizzes</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($quizzes as $quiz)
                                        <tr class="">
                                            ...
                                            <td>
                                                <p class="mb-0 pb-0">{{ $quiz->brand->title }}</p>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <p class="mb-0 pb-0">{{ $quiz->created_at }}</p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center justify-content-evenly">
                                                    <div class="edit table-action cursor-pointer">
                                                        <a
                                                            href="{{ URL::to("/learning-center/quiz/$quiz->id/questions") }}">
                                                    ...
                                                    <div class="delete table-action cursor-pointer">
                                                        <a onclick="deletefunction({{ $quiz->id }})"
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        type: "get",
                        url: "/learning-center/quiz/" + id + "/delete",
