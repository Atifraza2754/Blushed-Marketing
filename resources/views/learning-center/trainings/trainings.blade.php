                        ...
                        <div class="tab-div">
                            <div class="tab">
                                <a href="{{ URL::to('/learning-center/trainings') }}"
                                    class="tab-btn tab-btn-active">Training
                                    List</a>
                                <a href="{{ URL::to('/learning-center/user-trainings') }}" class="tab-btn">User Training
                                    Status</a>
                            </div>
                        </div>
                            ...
                            <table class="table dashboard-table  dashboard-table-sm tabcontent-table learning-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th >Training</th>
                                        <th >Brand</th>
                                        {{-- <th with="15%">Start Date</th> --}}
                                        {{-- <th with="15%">End Date</th> --}}
                                        <th >Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($trainings as $training)
                                        <tr class="">
                                            ...
                                            <td>
                                                <p class="mb-0 pb-0">{{ $training->title }}</p>
                                            </td>
                                            <td>
                                                <p>{{ $training->brand->title }}</p>
                                            </td>
                                            {{-- <td>
                                                <div class="d-flex align-items-center">
                                                    <p class="mb-0 pb-0">{{ $training->start_date }}</p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <p class="mb-0 pb-0">{{ $training->end_date }}</p>
                                                </div>
                                            </td> --}}
                                            <td>
                                                <div class="d-flex align-items-center ">
                                                    <div class="edit table-action cursor-pointer">
                                                        <a
                                                            href="{{ URL::to("/learning-center/training/$training->id/edit") }}">
                                                    ...
                                                    <div class="delete table-action cursor-pointer">
                                                        <a onclick="deletefunction({{ $training->id }})"
                                                    ...
                                                    <div class="eye table-action cursor-pointer">
                                                        <a
                                                            href="{{ URL::to("/learning-center/training/$training->id/view") }}">
                                                            <svg width="18" height="18" viewBox="0 0 24 24"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
