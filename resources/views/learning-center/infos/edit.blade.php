            ...
            <div class="col-lg-8 ">
                <div class="row">
                    <div class="col-lg-12 ">
                        ...
                        <h1 class="f-22 w-600 text-black text-center">{{ $info->brand->title }}</h1>
                        ...
                        <div class="tab-content-learinig">
                            <form action='{{ URL::to("/learning-center/info/$info->id") }}' method="POST"
                                enctype="multipart/form-data" class="sign__frame-right--form">
                                @csrf
                                @method('PUT')

                                {{-- brand_id --}}
                                <input type="hidden" name="brand_id" value="{{ $info->brand->id }}">

                                {{-- title --}}
                                <div class="col-md-12 form-floating mb-4">
                                    <input type="text" class="form-control sign-input" id="floatingInput" name="title"
                                        placeholder="" value="{{ $info->title }}" required>
                                    <label for="floatingInput" class="sign-label">Info Title</label>
                                </div>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        type: "get",
                        url: "/learning-center/info-file/" + id + "/delete",
