...
@section('title')
    Edit Recap Info - Learning Center
@endsection
    ...
    <div class="container">
        <div class="row mb-lg-4 mb-3 mt-lg-3 mt-3">
            ...
            <div class="col-lg-12">
                ...
                <p class="f-14 text-gray w-500 mt-1">Update and manage your recaps</p>
            </div>
            ...
            <div class="col-lg-8 ">
                <div class="row">
                    <div class="col-lg-12 ">
                        ...
                        <!-- Tab content -->
                        <div class="">
                            <form action='{{ URL::to("/learning-center/recap/$recap->id") }}' method="POST"
                                class="sign__frame-right--form" id="recap-form">
                                @csrf
                                @method('PUT')

                                <input type="hidden" name="brand_id" value="{{ $recap->brand_id }}">

                                <div class="question-div w-100">
                                    <div class="form-floating mb-4 w-100">
                                        <input type="text" class="form-control sign-input" id="floatingInput"
                                            name="title" value="{{ $recap->title }}" required>
                                ...
                                {{-- <div class="question-div w-100 mb-5">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4 w-100">
                                                <input type="date" class="form-control sign-input" id="floatingInput"
                                                    name="event_date"  value="{{ $recap->event_date }}" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4 w-100">
                                                <input type="date" class="form-control sign-input" id="floatingInput"
                                                    name="due_date"  value="{{ $recap->due_date }}" required>
                                ...
                                {{-- recap questions --}}
                                @forelse ($recap->questions as $question)
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="question-div w-100">
                                                    <div class="form-floating mb-3 w-100">
                                                        <input type="text" class="form-control sign-input"
                                                            id="floatingInput" name="questions[]"
                                                            value="{{ $question->title }}">
                                                        <label for="floatingInput sign-label">Question
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-floating w-100 mb-3">
                                                    <select class="form-select w-100 sign-input px-2 px-2"
                                                        id="floatingSelect" name="questiontypes[]"
                                                        aria-label="Floating label select example">
                                                        <option value="input-question"
                                                            {{ $question->question_type == 'input-question' ? 'selected' : '' }}>
                                                            Input</option>
                                                        <option value="textarea-question"
                                                            {{ $question->question_type == 'textarea-question' ? 'selected' : '' }}>
                                                            Textarea</option>
                                                        <option value="date-question"
                                                            {{ $question->question_type == 'date-question' ? 'selected' : '' }}>
                                                            Date</option>
                                                        <option value="select-question"
                                                            {{ $question->question_type == 'select-question' ? 'selected' : '' }}>
                                                            Select</option>
                                                        <option value="checkbox-question"
                                                            {{ $question->question_type == 'checkbox-question' ? 'selected' : '' }}>
                                                            Checkboxes</option>
                                                        <option value="radio-question"
                                                            {{ $question->question_type == 'radio-question' ? 'selected' : '' }}>
                                                            Radio</option>
                                                        <option value="image-question"
                                                            {{ $question->question_type == 'image-question' ? 'selected' : '' }}>
                                                            Image</option>
                                                    </select>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-floating mb-3 w-100">
                                                    <input type="text" class="form-control sign-input" id="floatingInput"
                                                        name="answers[]" value="{{ $question->options }}">
                                                    <label for="floatingInput sign-label">Options For Checkbox, Radio,
                                                        Dropdown
                                                        (separate with comma)
                                                    </label>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="question-div w-100">
                                                    <div class="form-floating mb-3 w-100">
                                                        <input type="text" class="form-control sign-input"
                                                            id="floatingInput" name="questions[]" required>
