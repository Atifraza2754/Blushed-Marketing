...
<body>
    <div class="dashboard-frame">
        <aside class="sidebar">
            <div class="side-logo">
                <img src="assets/images/blushed.png" alt="" class="">
            </div>
            <div class="side-nav">
                <ul class="ms-0 ps-0">
        ...
        <main class="main-area">
                                    ...
                                    <div class="d-flex align-items-center user-account ps-2">
                                        ...
                                        <div class="dropdown profile-dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                ...
                                                <li><a class="dropdown-item" href="sign-in.html">
            ...
            <div class="main-content">
                <div class="container">
                        ...
                        <div class="d-flex justify-content-between flex-lg-row flex-column ">
                            ...
                            <div
                                ...
                                <div class="d-flex mt-md-0 mt-3 justify-content-end align-items-center w-100">
                                    ...
                                    <button id="publish-btn" class="refresh-btn w-auto border-0 f-14 px-3  "
                                        type="button" disabled data-bs-toggle="modal" data-bs-target="#publishModal"
                    ...
                    <!-- cards -->
                    <div class="blushed-card" style="border-radius: 4px;
                    ...
                    <div class="blushed-card mt-4 mb-5" style="border-radius: 4px;
                    border: 1px solid var(--fill-dark-dark-5, #EBEAED);
                    background: var(--fill-white-white, #FFF);">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header mt-2 me-2 align-items-start">
                    <div>
                        <h5 class="f-22" style=" font-weight: 600; " id="exampleModalLabel">Add members to this job</h5>
                        ...
                        <div class="accordion-item shift-detail-box accordion-item-red">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                ...
                                <div class="satff-div-responsive">
                                    <div class="satff-div">
                                        <div
                                            class="d-flex align-items-center mb-2 shift-staf-row justify-content-between">
                    ...
                    <form class="sign__frame-right--form">
                        <div class="">
                            <p class="mb-0 pb-0 f-14 w-600">03-22-2023 &nbsp;&nbsp;&nbsp; 6pm - 09pm &nbsp;&nbsp;&nbsp;
                                <span class="text-primary">9</span> /10 Contractor</p>
    ...
    <script src="assets/Js/calendar-full.js"></script>
    <script>
